...
class GamesControllerTest < ActionController::TestCase
  ...
  test "should get new" do
    sign_in users(:user_three)
    get :new, params: { player_id: @player_two.id }
    assert_response :success
  end
  ...
  test "should create game" do
    ...
    assert_difference('Game.count') do
      post :create, params: { player_id: @player_one.id, game: {
  ...
  test "should show game" do
    get :show, params: { id: @game, player_id: @player_one }
    assert_response :success
  end

  test "should get edit" do
    sign_in users(:user_three)
    get :edit, params: { player_id: @player_one.id, id: @game }
    assert_response :success
  end

  test "should update game" do
    sign_in users(:user_three)
    patch :update, params: { player_id: @player_three.id, id: @game, game: { black_elo: @game.black_elo,
  ...
  test "should destroy game" do
    ...
    assert_difference('Game.count', -1) do
      delete :destroy, params: { player_id: @player_one.id, id: @game }
    end
